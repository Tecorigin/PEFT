...
class ModelArguments:
    ...
    load_in_bits: Optional[int] = field(default=None)
...
def train():
    ...
    if model_args.model_name_or_path:
        model = AutoModelForCausalLM.from_pretrained(
            ...
            # quantization_config=bnb_config_4bit if model_args.load_in_bits == 4 else None,
    ...
    if training_args.do_eval:
        ...
        metric = evaluate.load("llama2_accuracy.py")

...
def main(
        ...
        model_dir="/data/application/zhuzh/workspace/download/models--THUDM--chatglm3-6b-1/snapshots/06c7c873c843814171c51330b69c2e2a68e05178",
    ...
    trainer = Seq2SeqTrainer(
        ...
        data_collator=DataCollatorForSeq2Seq(
            tokenizer=tokenizer,
            padding="max_length",
            max_length=ft_config.max_input_length,
            return_tensors='pt',
        ),
